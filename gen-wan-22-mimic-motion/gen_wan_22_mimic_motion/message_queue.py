...
from gen_wan_22_mimic_motion.logger import get_logger

logger = get_logger(__name__)

PROJECT_ID = os.getenv("PROJECT_ID", "loom24-mvp")
RESULT_TOPIC_ID = os.getenv("RESULT_TOPIC_ID", "ai-model-result")
JOB_TOPIC_ID = os.getenv("JOB_TOPIC_ID", "gen-wan-22-mimic-motion")
SUBSCRIPTION_ID = os.getenv("SUBSCRIPTION_ID", "gen-wan-22-mimic-motion-sub")
