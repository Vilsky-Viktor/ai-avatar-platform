                ...
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-xl uppercase tracking-[0.2em] text-base-content/70">Delete avatar?</h3>
                        </div>
                        <p className="text-sm text-base-content/40 leading-relaxed pl-11">
                            <span className="text-base-content/70 uppercase tracking-wide">{avatar.name}</span> and all associated media will be permanently deleted.
                        </p>
                    </div>
