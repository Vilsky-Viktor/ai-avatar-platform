import { Camera, Video, X, Images, AudioLines } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
            ...
            <div className="relative bg-base-100 rounded-3xl shadow-2xl border border-base-content/5 p-12 animate-modal-card">
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    >
                        <Camera size={56} strokeWidth={1} className="text-base-content/30 group-hover:text-primary transition-colors duration-300" />
