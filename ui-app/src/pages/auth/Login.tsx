                    ...
                    <div className="w-full max-w-[400px] px-8 py-10 flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-xl uppercase tracking-[0.2em] text-base-content/70">Sign in</h1>
                            </div>
                            <p className="text-sm text-base-content/35 pl-11">Welcome back to loom24.</p>
                        </div>

                        <div className="flex flex-col gap-6">
                            {error && (
                                <div className="p-3 bg-error/5 border-l-2 border-error flex items-center gap-2">
                                    <AlertCircle size={14} className="text-error flex-shrink-0" />
                                    <p className="text-xs text-error/80 leading-tight">{error}</p>
                                </div>
                            )}

                            <form onSubmit={handlePlainLogin} className="flex flex-col gap-6">
                            ...
                            >
                                ...
                                <span className="text-sm uppercase tracking-[0.2em] text-base-content/50">Sign in with Google</span>
                            </button>
                        </div>

                        <p className="text-xs text-base-content/30 text-center">
                            No account?
                            <Link to="/auth/registration" className="ml-2 text-base-content/50 hover:text-primary border-b border-base-content/10 hover:border-primary transition-all duration-300">
                                Create one
                            </Link>
                        </p>
