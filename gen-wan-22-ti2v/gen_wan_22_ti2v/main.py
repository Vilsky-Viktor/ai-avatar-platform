...
from gen_wan_22_ti2v.logger import set_job_id, unset_job_id
import gen_wan_22_ti2v.db as db
import gen_wan_22_ti2v.message_queue as mq
import gen_wan_22_ti2v.storage as storage
from gen_wan_22_ti2v.models import Job
from gen_wan_22_ti2v import inference
...
def main():
    logger.info(f"Starting gen-wan-22-ti2v service (concurrency={MESSAGE_CONCURRENCY})")
