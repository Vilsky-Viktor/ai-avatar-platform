...
import gen_ti2i_controlnet.storage as storage_module
import gen_ti2i_controlnet.message_queue as mq_module
import gen_ti2i_controlnet.inference as inference_module
import gen_ti2i_controlnet.face_similarity as similarity_module
import gen_ti2i_controlnet.utils as utils_module
import gen_ti2i_controlnet.db as db_module
import gen_ti2i_controlnet.face_swap as face_swap_module
...
def load_images(job: dict) -> tuple:
    ...
    id_photos = storage_module.load_input_images(input_data.get("idPhotoPaths", []))
    reference_images = storage_module.load_input_images(input_data.get("imagePaths", []))
    control_image = storage_module.load_input_images([input_data.get("controlImage", "")])[0]
...
def generate_image(job: dict, reference_images: list, control_image):
    ...
    img = inference_module.run_inference(params, reference_images, control_image)
    return img
