...
export const genTrainingSyntheticIdPhotoData = (parameters: AvatarParameters, idPhotoSet: IdPhotoSetPaths): Partial<InferenceJob>[] => {
  ...
  return [
    ...
    },
    {
      ...
      metadata: { dimensions: trainingDimensions, ratio: '1:1', angle: '45:0', shotType: 'rightQuarterCloseUpView' },
      maxRuns: 7,
      order: 3,
    },
    {
      ...
      metadata: { dimensions: trainingDimensions, ratio: '1:1', angle: '45:0', shotType: 'leftQuarterCloseUpView' },
      maxRuns: 7,
      order: 4,
    },
    {
      ...
      metadata: { dimensions: trainingDimensions, ratio: '1:1', angle: '90:0', shotType: 'rightSideCloseUpView' },
      maxRuns: 7,
      order: 5,
    },
    {
      ...
      metadata: { dimensions: trainingDimensions, ratio: '1:1', angle: '90:0', shotType: 'leftSideCloseUpView' },
      maxRuns: 7,
      order: 6,
    },
    {
  ...
  return [
    {
      input: {
        checkDependencies: true,
        inference: {
          prompt: `Exact same person from input images. Change outfit to ${isFemale ? 'white strapless top' : 'white shirt with top undone buttons'}. ${bodyHair !== 'none' ? `${bodyHair} body hair` : 'No body hair'}. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
    ...
    //     checkDependencies: true,
    //     inference: {
    //       prompt: `Exact same person from input images. Change outfit to dark gray sleeveless t-shirt. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
    //       negativePrompt: 'disproportion, low quality, blurred face, blurry, distorted face, warped facial features, wrong body type, wrong body hair density, another person, changed identity, low resolution, compression artifacts',
    ...
    //       guidanceScale: 1.0,
    //     },
    //     faceRecognition: { enabled: true, mediaPaths: [idPhotoSet.uploaded.frontSmile!], threshold: { min: 0.95 }},
    //     loras: [
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Lightning-8steps-V1.0-bf16", scale: 0.55 },
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-InSubject", scale: 1.0 },
    //     ],
    ...
    //       negativePrompt: 'nose pointing left side of the frame, disproportion, low quality, blurry, distorted face, changed identity, low resolution, compression artifacts',
    ...
    //     checkDependencies: true,
    //     inference: {
    //       prompt: `<sks> right side view eye-level shot close-up. Pure 90 degree side view. Facing left side of the frame, nose pointing left side of the frame. Exact same person from input images. Change outfit to dark red t-shirt`,
    //       negativePrompt: 'nose pointing right side of the frame, quarter view, front view, disproportion, low quality, blurry, distorted face, changed identity, low resolution, compression artifacts',
    //       mediaPaths: [idPhotoSet.generated.rightQuarter!],
    //       numSteps: 8,
    //       width: trainingRatio[0],
    //       height: trainingRatio[1],
    ...
    //     },
    //     faceDirection: { enabled: true, direction: Directions.right },
    //     faceRecognition: { enabled: true, mediaPaths: [idPhotoSet.generated.rightQuarter!], threshold: { min: 0.85 }},
    //     loras: [
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Lightning-8steps-V1.0-bf16", scale: 0.55 },
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Multiple-Angles-LoRA", scale: 1.0 },
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-InSubject", scale: 1.0 },
    ...
    //     checkDependencies: true,
    //     inference: {
    //       prompt: `<sks> left side view eye-level shot close-up. Pure 90 degree side view. Facing right side of the frame, nose pointing right side of the frame. Exact same person from input images. Change outfit to dark brown t-shirt`,
    //       negativePrompt: 'nose pointing left side of the frame, quarter view, front view, disproportion, low quality, blurry, distorted face, changed identity, low resolution, compression artifacts',
    //       mediaPaths: [idPhotoSet.generated.leftQuarter!],
    //       numSteps: 8,
    //       width: trainingRatio[0],
    //       height: trainingRatio[1],
    ...
    //     },
    //     faceDirection: { enabled: true, direction: Directions.left },
    //     faceRecognition: { enabled: true, mediaPaths: [idPhotoSet.generated.leftQuarter!], threshold: { min: 0.85 }},
    //     loras: [
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Lightning-8steps-V1.0-bf16", scale: 0.55 },
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Multiple-Angles-LoRA", scale: 1.0 },
    //       { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-InSubject", scale: 1.0 },
    ...
    //     checkDependencies: true,
    //     inference: {
    //       prompt: `Tight crop around the head including haircut, face fills 90% of the frame. Shoulders and neck are cut off on the edges of the frame. Remove clothes. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
    //       negativePrompt: 'shoulders visible, disproportion, low quality, blurry, distorted face, changed identity, low resolution, compression artifacts',
    ...
    // },
    {
      input: {
        checkDependencies: true,
        inference: {
          prompt: `Upper body front view of subject in input images. Exact same person from input images. ${bodyHair !== 'none' ? `${bodyHair} body hair` : 'No body hair'}, ${bustSize} chest, ${height} height. Change outfit to ${isFemale ? 'white running shorts, white strapless top' : 'white running shorts, white t-shirt'}. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
          mediaPaths: [idPhotoSet.uploaded.front!, idPhotoSet.uploaded.front!, idPhotoSet.uploaded.front!],
          numSteps: 8,
          width: trainingRatio[0],
          height: trainingRatio[1],
          guidanceScale: 1.0,
    ...
    },
    {
      input: {
        checkDependencies: true,
        inference: {
          prompt: `Full body front view of subject in input images. Barefoot`,
        ...
        faceRecognition: { enabled: true, mediaPaths: [idPhotoSet.generated.front!, idPhotoSet.generated.upperBody!], threshold: { min: 0.93 }},
        loras: [
          { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Lightning-8steps-V1.0-bf16", scale: 0.7 },
        ],
      },
