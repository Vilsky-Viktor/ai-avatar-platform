  ...
  return [
    {
      input: {
        checkDependencies: true,
        inference: {
          prompt: `Exact same person from input images. Exact same body to head proportions as in image 1. Change outfit to ${isFemale ? 'white strapless top' : 'white polo with open buttons'}. ${bodyHair !== 'none' ? `${bodyHair} body hair` : 'No body hair'}. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
    ...
    },
    {
      input: {
        checkDependencies: true,
        inference: {
          prompt: `Exact same person from input images. Exact same body to head proportions as in image 1. Change outfit to dark gray sleeveless t-shirt. Change background to gray concrete color wall. Change lighting to even soft diffused studio light`,
          negativePrompt: 'disproportion, low quality, blurred face, blurry, distorted face, warped facial features, wrong body type, wrong body hair density, another person, changed identity, low resolution, compression artifacts',
    ...
    },
    {
      input: {
        ...
        loras: [
          ...
          { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-InSubject", scale: 1.0 },
          { path: "models/qwen-edit-2511/loras/qwen-edit-skin", scale: 0.9 },
        ],
      },
      metadata: { dimensions: trainingDimensions, ratio: '1:1', angle: '0:0', shotType: 'FrontUpperBodyView'},
      maxRuns: 5,
    ...
    },
    {
      input: {
        ...
        faceRecognition: { enabled: true, mediaPaths: [idPhotoSet.generated.front!], threshold: { min: 0.92 }},
        loras: [
          { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-2511-Lightning-8steps-V1.0-bf16", scale: 0.7 },
          { path: "models/qwen-edit-2511/loras/Qwen-Image-Edit-InSubject", scale: 1.0 },
