    ...
    return [
        {
            input: {
                ...
                loras: [
                    { path: Qwen2511Loras.lightning8stepsV2, scale: 0.5 },
                    { path: Qwen2511Loras.pixelSmile, scale: 1.0 },
        ...
        },
        {
            input: {
                ...
                faceExpression: { enabled: true, type: FaceExpressionTypes.angry, scale: 0.5 },
                faceRecognition: { enabled: true, mediaPaths: idPhotoPaths, threshold: { min: 0.94 } },
                loras: [
                    { path: Qwen2511Loras.lightning8stepsV2, scale: 0.5 },
                    { path: Qwen2511Loras.pixelSmile, scale: 1.0 },
...
export const genOutfitStylesData = (lora: LoraConfig, idPhotoPaths: string[], parameters: AvatarParameters): Partial<InferenceJob>[] => {
    ...
    const portraitSize = qwenEdit2511['9:16'];
    ...
    return [
        {
            ...
            metadata: { dimensions: portraitDimention, ratio: '9:16', angle: '0:0', shotType: 'frontFullBodyView' },
            maxRuns: 3,
            order: 1,
        },
        {
    ...
    return [
        {
            ...
            metadata: { dimensions: portraitDimention, ratio: '3:4', angle: '0:0', shotType: 'frontUpperBodyView' },
            maxRuns: 3,
            order: 1,
        },
        {
