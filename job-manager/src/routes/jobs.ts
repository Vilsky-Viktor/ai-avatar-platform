...
import { genSyntheticFrontIdPhoto, genSyntheticIdPhotos, genDigitalTwinIdPhoto } from '../controllers/idPhotoController';
...
router.post('/gen-digital-twin-id-photo', genDigitalTwinIdPhoto);
